...
const Card = ({ ele, setCartData,cartdata, index}) => {
  ...
  const increaseCount =(num)=>{
   ...
   newArr[num]={count:ele.count+1,data:cartdata[num]}
    ...
    <section className="text-black body-font bg-white shadow-md max-w-[1500px]  m-auto mx-5 mt-5 rounded-lg" >
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium  text-black">${ele.data.price}
          </h1>
          ...
          <div className="flex justify-between align-middle  w-48 h-18 text-white font-bold">
            <div className="w-12 text-center bg-red-500 rounded hover:bg-white hover:text-black active:bg-red-500"  onClick={() => increaseCount(index)}>-</div>
          ...
          <div className="p-2  mt-5  font-bold text-center w-[200px] bg-red-500 rounded hover:bg-white hover:text-black active:bg-red-500" onClick={() => handleRemoveFromCart(ele.data.id)}>Remove</div>
