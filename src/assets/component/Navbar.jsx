...
const Navbar = ({length}) => {
  return (
    ...
    <div className="logo flex font-bold justify-center m-auto md:m-1 border p-2 rounded-lg">Shopp<span className="text-red-500 flex items-center">inger<FaBagShopping /></span></div>
