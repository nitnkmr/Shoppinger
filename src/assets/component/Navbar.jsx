...
const Navbar = ({length}) => {
  return (
    ...
    <Link to="/"><div className="logo flex font-bold justify-center m-auto md:m-1 flex-ro border p-2 rounded-lg">Shopp<span className="text-red-500 my-2 flex items-center">inger<FaBagShopping /></span></div></Link>
