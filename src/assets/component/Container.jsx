...
const Container = ({ cartdata, setCartData, data }) => {
    ...
    return (
               <> <div className="flex justify-center max-w-120 align-middle flex-col mb-3 sm:flex-row sm:w-full sticky top-3 z-10">
                    <button className="border w-48 bg-red-500 p-1">Men </button>
                    <button className="border w-48 bg-red-500">Women </button>
                    <button className="border w-48 bg-red-500">Electronics </button>
                    <button className="border w-48 bg-red-500">Jwellery </button>
                </div>
